...
import educationSvg from "../assets/reading-boy.jpg";
      ...
      <div className="education-content">
        ...
        <div className="edu-details-wrapper">
          ...
          >
            ...
            <p className="edu-course">Bsc. in Computer Science</p>
            <p className="edu-duration">june 2021 - may 2024</p>
            <p className="edu-cgpa">CGPA : 7.81</p>
          </EduDetailsWrapper>
          ...
          >
            ...
            <p className="edu-institute">
              <span>
                <img src={udemy} alt="relevelLogo" className="edu-logo" />
              </span>
              Udemy
            </p>
            ...
            <a
              href="https://www.udemy.com/certificate/UC-dbc7952c-fb37-4488-b29a-a98ac1044206/"
              target="_blank"
              rel="noreferrer"
            >
